    ...
    var body: some View {
        ...
        VStack {
            ...
            VStack(spacing: 10.0) {
                ...
                Text("Ever notice how much plastic you use?").font(.custom("AlegreyaSansSC-Regular", size: 25)).multilineTextAlignment(.center).fixedSize(horizontal: false, vertical: true)
